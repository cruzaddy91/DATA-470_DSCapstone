...
SHOWCASE_TEMPLATE = "Showcase Templates.pptx"
# Default build output: never the fact file — see ``run_poster_from_fact``.
OUTPUT = os.environ.get("POSTER_PPTX_OUTPUT", "DS_Capstone_Poster_FULL_RENDER.pptx")
...
if __name__ == "__main__":
    ...
    if os.environ.get("POSTER_BUILD_MODE", "fact") == "fact":
        _msg = run_poster_from_fact(
            REPO_ROOT,
            os.environ.get("POSTER_FACT_PPTX", "DS_Capstone_Poster_FINAL_SCRIPT_COPY.pptx"),
            os.environ.get("POSTER_PPTX_OUTPUT", "DS_Capstone_Poster_FULL_RENDER.pptx"),
