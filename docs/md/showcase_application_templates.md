# Showcase application templates

Optional, venue-neutral copy for symposium-style abstracts, posters, and short project descriptions. Wording matches the stabilized order-time `v2` modeling path.
...
Use these sections in the poster layout.
...
Program-specific fields (mentor name, contact email, employer mentions) belong in each venue’s submission portal. Keep this repository copy institution-neutral and free of bracket placeholders.
